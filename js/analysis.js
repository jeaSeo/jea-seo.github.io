...
let comments1, comments2, comments3
...
const readCsv = (path) => {
    ...
    .then(df => {
        ...
        if (ar.at(0).at(3) === 'episode') {
            first_positive_5_genre        = Math.ceil(lastdataDf.at(0).at(11))
            second_view_1_genre           = Math.ceil(lastdataDf.at(0).at(12))
            third_rating_people_5_genre   = Math.ceil(lastdataDf.at(0).at(13))
            positive_genre                = Math.ceil(lastdataDf.at(0).at(26))
            view_genre                    = Math.ceil(lastdataDf.at(0).at(27))
            rating_people_genre           = Math.ceil(lastdataDf.at(0).at(28))
        } else if (ar.at(0).at(3) === 'omnibus') {
            first_positive_5_genre        = Math.ceil(lastdataDf.at(0).at(14))
            second_view_1_genre           = Math.ceil(lastdataDf.at(0).at(15))
            third_rating_people_5_genre   = Math.ceil(lastdataDf.at(0).at(16))
            positive_genre                = Math.ceil(lastdataDf.at(0).at(29))
            view_genre                    = Math.ceil(lastdataDf.at(0).at(30))
            rating_people_genre           = Math.ceil(lastdataDf.at(0).at(31))
        } else if (ar.at(0).at(3) === 'story') {
            first_positive_5_genre        = Math.ceil(lastdataDf.at(0).at(17))
            second_view_1_genre           = Math.ceil(lastdataDf.at(0).at(18))
            third_rating_people_5_genre   = Math.ceil(lastdataDf.at(0).at(19))
            positive_genre                = Math.ceil(lastdataDf.at(0).at(32))
            view_genre                    = Math.ceil(lastdataDf.at(0).at(33))
            rating_people_genre           = Math.ceil(lastdataDf.at(0).at(34))
        }
...
const commentsDetail = (comTarget1, comTarget2, wtIndx, totalIndex, unit) => {
    ...
    comments2 += '<div class="item"><span>' + userLabel.at(10+totalIndex)  + '</span><span class="count">'
    comments1 += ((Math.round(armax.at(wtIndx)) * 100)/100).toLocaleString() + unit + '</em></span></div>'
    comments2 += ((Math.round(armax.at(totalIndex)) * 100)/100).toLocaleString() + unit +'</em></span></div>'

    if ((((Math.round(armax.at(totalIndex)) - Math.round(armax.at(wtIndx))) * 100)/100)<0) {
        comments2 += '<div>최고 '+ userLabel.at(10+wtIndx) + ' 기준 정식연재된 작품과 비교해 </div><div>약 ' + '<em class="' + 'high' + '">' + (((Math.round(armax.at(wtIndx)) - Math.round(armax.at(totalIndex))) * 100)/100).toLocaleString() + unit +'</em> 많아요!</div>'
    } else {
        comments2 += '<div>최고 '+ userLabel.at(10+wtIndx) + ' 기준 정식연재된 작품과 비교해 </div><div>약 ' + '<em class="' + 'low' + '">' + (((Math.round(armax.at(totalIndex)) - Math.round(armax.at(wtIndx))) * 100)/100).toLocaleString() + unit + '</em> 적어요.</div>'
    }

    comments3 += userLabel.at(10+wtIndx) + '에 대한 분석'
    comments1 += comments2
    comment_target1.innerHTML = comments1
    comment_target2.innerHTML = comments3
}